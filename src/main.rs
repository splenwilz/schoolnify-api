...
//             .route("/update_user/{id}", web::put().to(update_user_handler))  // PUT route for updating user details
//             .route("/delete_user/{id}", web::delete().to(delete_user_handler))  // DELETE route for deleting a user
...
// async fn delete_user_handler(pool: web::Data<PgPool>, user_id: web::Path<Uuid>) -> impl Responder {
